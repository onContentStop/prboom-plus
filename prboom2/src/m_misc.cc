...
default_t defaults[] = {
    ...
    {"lowpass_filter",
     ...
     1,
     default_t::def_bool,
     ss_none}, // low-pass filter borrowed from Chocolate Doom so upscaling old
               // audio doesn't sound too horrible
    {"full_sounds",
     {&full_sounds},
     {0},
     0,
    ...
    {"screenblocks",
     ...
     {10},
     3,
     11, // killough 2/21/98: default_t::default to 10
     default_t::def_int,
     ss_none},
    {"usegamma",
     {&usegamma},
    ...
    {"mouseb_use",
     ...
     ss_keys}, // mouse button number to use for using doors/switches
               // jff 3/8/98 end of lower range change for -1 allowed in mouse
               // binding
    ...
    // For key bindings, the values stored in the key_* variables       //
    // phares
    // are the internal Doom Codes. The values stored in the
    // default_t::default.cfg
    ...
    {"key_menu_right",
     {&key_menu_right},
     {KEYD_RIGHTARROW}, // phares 3/7/98
     0,
     MAX_KEY,
     default_t::def_key,
     ss_keys}, // key to move right in a menu  //     |
    {"key_menu_left",
     {&key_menu_left},
     {KEYD_LEFTARROW}, //     V
     0,
     MAX_KEY,
     default_t::def_key,
     ss_keys}, // key to move left in a menu
    {"key_menu_up",
     {&key_menu_up},
     {KEYD_UPARROW},
     0,
    ...
    {"key_map_right",
     ...
     MAX_KEY,
     default_t::def_key,
     ss_keys}, // key to shift automap right   //     |
    {"key_map_left",
     {&key_map_left},
     {KEYD_LEFTARROW}, //     V
     0,
     MAX_KEY,
     default_t::def_key,
     ss_keys}, // key to shift automap left
    {"key_map_up",
     {&key_map_up},
     {KEYD_UPARROW},
     0,
    ...
    {"key_map_rotate",
     ...
     MAX_KEY,
     default_t::def_key,
     ss_keys}, // key to toggle rotating the automap to match the player's
               // orientation
    {"key_map_overlay",
     {&key_map_overlay},
     {'o'},
    ...
    {"joy_left", {&joyleft}, {0}, UL, UL, default_t::def_int, ss_none},
    {"joy_right", {&joyright}, {0}, UL, UL, default_t::def_int, ss_none},
    {"joy_up", {&joyup}, {0}, UL, UL, default_t::def_int, ss_none},
    {"joy_down", {&joydown}, {0}, UL, UL, default_t::def_int, ss_none},
    {"joyb_fire",
     {&joybfire},
     {0},
     0,
    ...
    {"Heads-up display settings",
     ...
     default_t::def_none,
     ss_none},
    // jff 2/16/98 default_t::defaults for color ranges in hud and status
    {"hudcolor_titl",
     {&hudcolor_titl},
     {5},
     0,
